...
<Steps>
  ...
  <Step title="Choose a scoring mode">
    ...
    Not sure which mode fits your group? See [Scoring modes](/guides/scoring-modes) for a full breakdown.
  </Step>
  ...
  <Step title="Invite your group">
    ...
    See [Invite members](/guides/invite-members) for all the ways to share and what happens when your pool grows past 25 members.
  </Step>
</Steps>
