...
<AccordionGroup>
  ...
  <Accordion title="El organizador cambió las reglas — ¿qué pasa con mis predicciones?">
    Los organizadores pueden ajustar las reglas hasta que arranque el primer partido del torneo. Tus predicciones existentes se mantienen, pero cualquier nuevo plazo aplica desde el momento del cambio.
  </Accordion>
</AccordionGroup>
